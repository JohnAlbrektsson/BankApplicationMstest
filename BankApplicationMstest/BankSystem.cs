...
namespace BankApplication
{
    ...
    public class BankSystem
    {
        ...
        public static void OpenAccount(Customer customer, string newAccount, string curchoice)
        {
            ...
            while (true)
            {
                ...
                if (customer.accounts.ContainsKey(newAccount))
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        customer.accounts.Add(newAccount, new List<string>() { 0.0f.ToString(), curchoice.ToLower(), "Personkonto" });
